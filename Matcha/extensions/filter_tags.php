				...
				<center>
					<form method="POST">
						<p style="color: black!important">
							<div class="wrap-input100 validate-input m-b-25" style="text-align: center;">
								<input class="input100" minlength="2" type="text" id="seed_two" value="" name="i2" placeholder="filter interest here">
