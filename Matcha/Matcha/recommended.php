...
<html lang="en">
    ...
    <body>
		...
		if ($_SESSION['auth']->name === "Unknown" || $_SESSION['auth']->age == 0 || $_SESSION['auth']->profile_img === "../img/profile.png")
		...
		<div class="banner-home" style="background-image: url('../images/bg-01.jpg');">
			<div class=" container" style="position: absolute; top: 5%; height: 80%; color: whitesmoke; z-index: 2;">
				<center>
					<span class="class">
                		Suggested list for you
					</span>		
			</center>
			</div>
			<div class="container" style="position: absolute; top: 15%; height: 80%; color: whitesmoke; z-index: 2; overflow-y: scroll;">
				<?php
					...
					$res = $req->fetchall();
					foreach (array_slice($res, 0, rand(1,6)) as $currentUser) {
						...
						if ($_SESSION['auth']->id != $currentUser->id && !$blocked && ($currentUser->orientation === $_SESSION['auth']->gender || $currentUser->orientation === "M-F")){ ?>
							<a href="uprofile.php?id=<?php echo $currentUser->id; ?>"  style="color: whitesmoke;">
								<div class="profile-box">
									<h1 class="profile-box-h1">
										<?php echo $currentUser->name; ?> 
										- 
										<span>
											<?php echo $currentUser->age; ?>
										</span>
									</h1>

									<h2 class="profile-box-h2">
										<i class="fa fa-map-marker" aria-hidden="true"></i>
										<?php echo $local; ?>
									</h2>
									<h2 class="profile-box-h2-pts" style="color: gold;">
										<i class="fa fa-star" aria-hidden="true"></i>
										<?php echo $currentUser->popscore; ?>
									</h2>
