<?php
	...
	if (!empty($_POST))
	{
		...
		if (move_uploaded_file($_FILES['my_files']['tmp_name'], $uploadfile)) {
			...
			$req = $pdo->prepare('UPDATE users SET img4 = ? WHERE id = ?');
			$req->execute(["../img/user/" .$_SESSION['auth']->id ."/profile".$r.".jpg", $_SESSION['auth']->id]);
            $_SESSION['auth']->img4 = "../img/user/" .$_SESSION['auth']->id ."/profile".$r.".jpg";
            put_flash('success', "image 4: uploaded successful.", "../extensions/edit_photos.php");
