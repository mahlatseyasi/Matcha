...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `activation-code` int(11) NOT NULL DEFAULT '0',
  `active status` int(11) NOT NULL DEFAULT '0',
  ...
  `profile_img` varchar(255) NOT NULL DEFAULT '../img/profile.png',
  `img1` varchar(255) NOT NULL DEFAULT '../img/profile.png',
  `img2` varchar(255) NOT NULL DEFAULT '../img/profile.png',
  `img3` varchar(255) NOT NULL DEFAULT '../img/profile.png',
  `img4` varchar(255) NOT NULL DEFAULT '../img/profile.png',
